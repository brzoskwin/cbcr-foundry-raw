...
gradle_dist="gradle-8.12.1-bin.zip"
...
then
    if [ -n "${FOUNDRY_HOSTNAME:-}" ] && [ -n "${FOUNDRY_TOKEN:-}" ] && [ -n "${FOUNDRY_USERNAME:-}" ]; then
        ...
        if [ $ret -ne 0 ]; then
            ...
            strip_from_rid="ri.stemma.main${strip_before_host##*ri.stemma.main}"
            export REPOSITORY_RID="${strip_from_rid%%/*}"
        fi
    fi

    export ORG_GRADLE_PROJECT_externalUri="https://${GIT_REMOTE_HOST}"
    export ORG_GRADLE_PROJECT_transformsBearerToken="${GIT_REMOTE_PASSWORD}"

    export ORG_GRADLE_PROJECT_artifactsUri="${ORG_GRADLE_PROJECT_externalUri}/artifacts/api"
    ...
    export JAVA_TOOL_OPTIONS="-XX:+IgnoreUnrecognizedVMOptions --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.lang.invoke=ALL-UNNAMED --add-opens=java.base/java.lang.reflect=ALL-UNNAMED --add-opens=java.base/java.io=ALL-UNNAMED --add-opens=java.base/java.net=ALL-UNNAMED --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/java.util.concurrent=ALL-UNNAMED --add-opens=java.base/java.util.concurrent.atomic=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED --add-opens=java.base/sun.nio.cs=ALL-UNNAMED --add-opens=java.base/sun.security.action=ALL-UNNAMED --add-opens=java.base/sun.util.calendar=ALL-UNNAMED --add-opens=java.security.jgss/sun.security.krb5=ALL-UNNAMED"

    if [ -z "${REPOSITORY_RID:-}" ]; then
        export ORG_GRADLE_PROJECT_transformsMavenProxyRepoUri="${ORG_GRADLE_PROJECT_artifactsUri}/legacy/mrp/authz/all"
    else
